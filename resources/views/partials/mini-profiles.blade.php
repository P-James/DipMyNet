    ...
    <div class="flex flex-wrap md:flex-no-wrap w-full bg-white shadow-lg rounded-lg overflow-hidden relative">
        ...
        <div class="w-full md:w-2/3 p-4">
            ...
            <div class="flex item-center justify-start mt-3">
                <h2 class="w-2/5">Address:</h2>
                <span class="text-teal-700">{{$fishery->address['roadName']}}, {{$fishery->address['town']}}, {{$fishery->address['county']}}</span>
            </div>
            <div class="flex item-center justify-start mt-3">
                <h2 class="w-2/5">Post Code:</h2>
                <span class="text-teal-700">{{$fishery->post_code}}</span>
            </div>
            <div class="flex item-center justify-start mt-3">
                <h2 class="w-2/5">Opening Hours:</h2>
                <span class="text-teal-700">Mon - Fri: {{$fishery->opening_times['week']}} / Sat - Sun: {{$fishery->opening_times['weekend']}}</span>
            </div>
            <div class="flex item-center justify-start mt-3">
                <h2 class="w-2/5">Facilities:</h2>
            ...
            <div class="flex item-center justify-start mt-3">
                <h2 class="w-2/5">Prices:</h2>
                <span class="text-teal-700">Day ticket: £{{$fishery->prices['day']}} / Night ticket: £{{$fishery->prices['night']}}</span>
            </div>

        </div>

        <a href="{{$fishery->path()}}" class="button absolute right-0 bottom-0 m-4 px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded"> More Info </a>
